...
//             <div className="form-group">
//               <label>Land Type Index (0: Barren, 1: Rangeland)</label>
//               <input type="number" name="land_type_enc" className="form-control" value={formData.land_type_enc} onChange={handleInputChange} />
//             </div>

//             <div className="form-group">
//               <label>Soil Type Index (3: Sandy, 1: Loamy)</label>
//               <input type="number" name="soil_type_enc" className="form-control" value={formData.soil_type_enc} onChange={handleInputChange} />
//             </div>
